namespace SphincsPlus.Hashing
{
    internal interface ISphincsPlusHashing
    {
        ...
        byte[] Prf(byte[] pkSeed, byte[] skSeed, byte[] adrs);
        ...
        byte[] H(byte[] pkSeed, byte[] adrs, byte[] m2);
